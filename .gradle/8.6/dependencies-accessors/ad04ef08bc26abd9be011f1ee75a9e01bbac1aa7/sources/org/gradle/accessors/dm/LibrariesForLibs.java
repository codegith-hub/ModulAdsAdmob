...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final InappLibraryAccessors laccForInappLibraryAccessors = new InappLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>pangle</b> with <b>com.google.ads.mediation:pangle</b> coordinates and
     * with version reference <b>pangle</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getPangle() {
        return create("pangle");
    }

    /**
     * Dependency provider for <b>unity</b> with <b>com.google.ads.mediation:unity</b> coordinates and
     * with version reference <b>unity</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    /**
     * Group of libraries at <b>inapp</b>
     */
    public InappLibraryAccessors getInapp() {
        return laccForInappLibraryAccessors;
    }
    ...
    public static class InappLibraryAccessors extends SubDependencyFactory {

        public InappLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>sdk</b> with <b>com.startapp:inapp-sdk</b> coordinates and
         * with version reference <b>inappSdk</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSdk() {
            return create("inapp.sdk");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>applovin</b> with value <b>12.5.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>facebook</b> with value <b>6.17.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>inappSdk</b> with value <b>5.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getInappSdk() { return getVersion("inappSdk"); }
        ...
        /**
         * Version alias <b>masterads</b> with value <b>1.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>onesignal</b> with value <b>5.1.17</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>pangle</b> with value <b>6.0.0.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>unity</b> with value <b>4.12.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getUnity() { return getVersion("unity"); }

        /**
         * Version alias <b>userMessagingPlatform</b> with value <b>2.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
